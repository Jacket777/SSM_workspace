...
//    @Before("execution( public Integer com.msb.service.MyCalculator.add(Integer,Integer))")
//    public static void start() {
//        System.out.println(" 方法开始 执行参数是");
//    }
//
//    @AfterReturning("execution( public Integer com.msb.service.MyCalculator.add(Integer,Integer))")
//    public static void stop() {
//        System.out.println(" 方法执行完成，结果是 ");
//    }
//
//
//    @AfterThrowing("execution( public Integer com.msb.service.MyCalculator.add(Integer,Integer))")
//    public static void LogException() {
//        System.out.println("方法出现异常： ");
//    }
//
//    @After("execution( public Integer com.msb.service.MyCalculator.add(Integer,Integer))")
