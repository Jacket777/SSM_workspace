...
public class MyTest {
  ...
  ClassPathXmlApplicationContext context =   new ClassPathXmlApplicationContext("applicationContext.xml");
    ...
    public void test06(){
        ...
        Emp result = jdbcTemplate.queryForObject(sql,new BeanPropertyRowMapper<Emp>(Emp.class),7369);
    ...
    public void test07(){
        ...
        List<Emp> result = jdbcTemplate.query(sql,new BeanPropertyRowMapper<Emp>(Emp.class),1500);
        for (Emp emp : result) {
